...
const Register = () => {
    return (
      ...
      <div className="flex w-3/4 h-3/4 ">
        ...
        {/* login right */}
        <div className="flex flex-[1] flex-col  justify-center items-center ">
          <div className="h-[400px] w-3/4 p-5 bg-white rounded-md flex flex-col justify-between">
            ...
            <input type="password" placeholder="Password" className="h-10 rounded-md border p-5 outline-none"/>
            <button className="h-10 bg-[#1775ee] text-white rounded-md">Sign Up</button>
            <button className="bg-[#42b72a] rounded-md h-10 w-[60%] text-white self-center ">Log into Account</button>
          </div>
        </div>
      </div>
    </div>
